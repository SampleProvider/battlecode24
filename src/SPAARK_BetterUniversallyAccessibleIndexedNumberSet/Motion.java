...
public class Motion {
    ...
    protected static MapLocation getSafest(MapLocation[] a) throws GameActionException {
        ...
        int robots = UniversallyAccessibleIndexedNumberSet.getNumberOfOpponentRobots(rc.readSharedArray(UniversallyAccessibleIndexedNumberSet.locationToSector(a[0])));
        for (MapLocation loc : a) {
            int r = UniversallyAccessibleIndexedNumberSet.getNumberOfOpponentRobots(rc.readSharedArray(UniversallyAccessibleIndexedNumberSet.locationToSector(loc)));
