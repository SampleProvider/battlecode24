...
public class Motion {
    ...
    protected static void micro(MapLocation dest) throws GameActionException {
        if (rc.isMovementReady()) {
            ...
            MapLocation closestSpawnLoc = getClosest(spawnLocs);
            for (Direction d : ALL_DIRECTIONS) {
                ...
                // if (me.distanceSquaredTo(closestSpawnLoc) > me.add(d).distanceSquaredTo(closestSpawnLoc)) {
                //     weight += 10;
                // }
                ...
                for (RobotInfo robot : opponentRobots) {
                    ...
                    // else if (me.distanceSquaredTo(relativeLoc) <= 20) {
                    //     weight -= 1;
                    //     if (rc.getHealth() < 500) {
                    //         weight -= 5;
                    //     }
